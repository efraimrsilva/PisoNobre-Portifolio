...
assert.match(pageSource, /\["Serviços", "Antes e depois", "Processo", "Por que a Piso Nobre", "Dúvidas"\]/, 'the header navigation must include the Piso Nobre value section after the process')
assert.match(pageSource, /\["#servicos", "#resultados", "#processo", "#por-que-escolher", "#faq"\]/, 'the header navigation must target the new section anchor')
assert.match(pageSource, /href="#processo"[\s\S]*?Processo/, 'the footer must link to the process section')
assert.match(pageSource, /href="#por-que-escolher"[\s\S]*?Por que a Piso Nobre/, 'the footer must link to the Piso Nobre value section')
